...
<body>
    ...
    <main>
        ...
        <section class="servico">
            <article class="site">
                ...
                <?php require("conteudo/servico.php") ?>
                <!-- foi deixado apenas esse "require" para poder repetir esse php, foi retirado o "_once" para aparecer o mesmo conteudo várias fezes  -->
                <?php require("conteudo/servico.php") ?>
                <?php require("conteudo/servico.php") ?>
            </article>
        </section>
    ...
    <footer>
        ...
        <!-- Nesse caso foi pego todas as classes que estavam dentro da footer (rodapé) e colocado no arquivo "footer.php" -->
        <!--FIM DO RODAPÉ-->
